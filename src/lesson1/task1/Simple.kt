...
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {
    val allDegress: Double = deg + min.toDouble() / 60 + sec.toDouble() / 3600

    return allDegress * Math.PI / 180.0
}
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val allMinutesDepart = hoursDepart * 60 + minutesDepart
    val allMinutesArrive = hoursArrive * 60 + minutesArrive
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val summ = initial * (1 + percent / 100.0).pow(3)
